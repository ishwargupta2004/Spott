...
export default function OnboardingModal({ isOpen, onClose, onComplete }) {
  ...
  const [isLoading, setIsLoading] = useState(false); // ✅ Convex ka isLoading replace
        ...
        <div className="py-4">
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-[250px] overflow-y-auto p-2">
